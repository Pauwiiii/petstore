          ...
          <Container maxWidth="lg">
            <Grid container spacing={4}>
              <Grid item xs={12} md={4}>
                <Stack spacing={2}>
                  ...
                  <Typography variant="body2" sx={{ opacity: 0.9, lineHeight: 1.8 }}>
                    Premium pet adoption and boutique supplies. We help you find the perfect companion for your home with care and love.
                  </Typography>
              ...
              <Grid item xs={6} md={2}>
                ...
                <Stack spacing={1}>
                  <Link to="/" style={{ color: 'white', textDecoration: 'none', fontSize: '0.875rem' }}>Gallery</Link>
                  <Link to="/admin" style={{ color: 'white', textDecoration: 'none', fontSize: '0.875rem' }}>Admin Dashboard</Link>
